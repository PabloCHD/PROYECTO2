...
namespace ReservacionesBL
{
    ...
    public class FacturaBL
    {
        ...
        public void CalcularFactura(Factura factura)
        {
            if (factura != null)
            {
                ...
                {
                    var habitacion = _contexto.Reservaciones.Find(detalle.ReservacionId);
                    if (habitacion != null)
                    {
                        detalle.Precio = habitacion.Precio;
                        detalle.Total = detalle.Dias * habitacion.Precio;
                ...
                factura.Impuestos = subtotal * 0.15;
    ...
    public class Factura        
    {
        ...
        public Reservacion Cliente { get; set; }
